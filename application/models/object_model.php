...
class Object_model extends CI_Model {
    ...
    $rarity			= $this->input->post('rarity');
    $timemodified		= time();
    $modifiedBy = $this->user_model->get()->id;

		$sql = 'UPDATE {pre}object SET name=?, description=?, rarity=?, modifiedBy=?, timemodified=? WHERE id=?';

		$data = array($name, $description, $rarity, $modifiedBy, $timemodified, $id);
