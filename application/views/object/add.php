...
<div class="center_me">
	...
	<div class="form_container">
	    ...
	    <div class="form_title"><?php echo lang('add').' Object'; ?></div>
	    
		<?php echo form_open_multipart('object/add', 'class="my_form"'); ?>
		...
		<table class="form_table">
		    ...
		    <tr><td class="field_title" colspan="2" style="text-align: left;">Description:</td></tr>
		    <tr><td class="field_value" colspan="2"><textarea class="my_textarea use_tinymce" style="width: 400px; height: 100px;" name="description">
		    <?php echo set_value('description'); ?></textarea></td></tr>
			...
			<tr>
				...
				<td class="field_value"><?php echo $this->rarity_model->get_select(set_value('rarity')); ?></td>
			</tr>
