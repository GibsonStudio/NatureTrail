...
<div class="center_me">
	...
	<div class="form_container">
	    ...
	    <div class="form_title"><?php echo lang('add').' Role'; ?></div>
	    
		<?php echo form_open('role/add', 'class="my_form"'); ?>
		...
		<table class="form_table">
		    ...
		    <tr>
		        ...
		        <td class="field_value"><input type="number" class="my_input" name="level" value="<?php echo set_value('level', 0); ?>" /></td>
		    </tr>
