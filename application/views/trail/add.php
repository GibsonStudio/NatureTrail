...
<div class="center_me">
	...
	<div class="form_container">
	    ...
	    <div class="form_title"><?php echo lang('add').' Trail'; ?></div>
	    
		<?php echo form_open('trail/add', 'class="my_form"'); ?>
		...
		<table class="form_table">
		    ...
		    <tr>
				...
				<td class="field_value"><?php echo $this->availability_model->get_select(set_value('availability')); ?></td>
			</tr>
