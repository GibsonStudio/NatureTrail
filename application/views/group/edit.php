...
<div class="center_me">
	...
	<div class="form_container">
	    ...
	    <div class="form_title"><?php echo lang('edit').' Group '.$group->id; ?></div>
	    
		<?php echo form_open('group/edit/'.$group->id, 'class="my_form"'); ?>
		...
		<table class="form_table">
		    ...
		    <tr>
		        ...
		        <td class="field_value"><input type="text" class="my_input" name="name" value="<?php echo set_value('name', $group->name); ?>" /></td>
		    </tr>
		    ...
		    <tr><td class="field_value" colspan="2"><textarea class="my_textarea use_tinymce" style="width: 400px; height: 300px;" name="description"><?php echo set_value('description', $group->description); ?></textarea></td></tr>
