...
<div class="form_container">
    ...
    <div class="form_title"><?php echo lang('register'); ?></div>  
    
<?php echo form_open('user/register', 'class="my_form"'); ?>
...
<table class="form_table">
    ...
    <tr>
        <td class="field_title form_required"><?php echo lang('email'); ?> <span class="form_constraint"><?php echo lang('email_extra'); ?></span></td>        
