...
<div class="center_me">
	...
	<div class="form_container">
	    ...
	    <div class="form_title"><?php echo lang('add').' Block'; ?></div>
	    
		<?php echo form_open('block/add', 'class="my_form"'); ?>
		...
		<table class="form_table">
		    ...
		    <tr>
		        ...
		        <td class="field_value"><input type="text" class="my_input" name="title" value="<?php echo set_value('title'); ?>" /></td>
		    </tr>
		    ...
		    <tr><td class="field_value" colspan="2"><textarea class="my_textarea use_tinymce" style="width: 400px; height: 300px;" name="content"><?php echo set_value('content'); ?></textarea></td></tr>
		    <?php if (form_error('content')) { echo '<tr><td class="form_error" colspan="2">'.form_error('content').'</td></tr>'; } ?>
		     ...
		     <tr>
		        ...
		        <td class="field_value"><?php echo $this->data_model->get_boolean_select('active', set_value('active')); ?></td>
		    </tr>
		    ...
		    <tr>
		        ...
		        <td class="field_value"><?php echo $this->data_model->get_position_select('position', set_value('position')); ?></td>
		    </tr>
		    ...
		    <tr>
		        ...
		        <td class="field_value"><?php echo $this->data_model->get_boolean_select('show_content_only', set_value('show_content_only')); ?></td>
		    </tr>
		    ...
		    <tr>
		        ...
		        <td class="field_value"><input type="number" name="sort" value="<?php echo set_value('sort', 0); ?>" /></td>
		    </tr>
