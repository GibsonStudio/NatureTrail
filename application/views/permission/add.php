...
<div class="center_me">
	...
	<div class="form_container">
	    ...
	    <div class="form_title"><?php echo lang('add').' Permission'; ?></div>
	    
		<?php echo form_open('permission/add', 'class="my_form"'); ?>
		...
		<table class="form_table">
		    ...
		    <tr>
		        ...
		        <td class="field_value"><?php echo $this->data_model->get_boolean_select('heading', set_value('heading', 0)); ?></td>
		    </tr>
		    ...
		    <tr>
		        ...
		        <td class="field_value"><input type="number" class="my_input" name="sort" value="<?php echo set_value('sort', 0); ?>" /></td>
		    </tr>
		    ...
		    <tr>       
		        <td colspan="2" class="field_value">
		        	<textarea class="my_textarea" style="width:400px; height:100px;" name="description"><?php echo set_value('description'); ?></textarea>
		        </td>
		    </tr>
