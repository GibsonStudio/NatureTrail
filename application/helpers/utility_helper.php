...
function use_tinymce ()
{
	...
	$code .= 'mode: "specific_textareas", editor_selector: "use_tinymce"';
	$code .= ', plugins: ["code textcolor link image"]';
	$code .= ', toolbar: "fontselect fontsizeselect forecolor backcolor | bullist numlist"';
	$code .= ', image_advtab: true';
	$code .= ', convert_urls: false';
	//$code .= ', document_base_url: "http://localhost/caeoaaappforms/images/"';
	$code .= ' });';
